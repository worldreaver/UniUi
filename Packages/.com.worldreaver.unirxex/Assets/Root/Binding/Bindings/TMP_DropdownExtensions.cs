...
namespace ExtraUniRx.Bindings
{
    ...
    public static class TMP_DropdownExtensions
    {
        ...
        public static IDisposable BindOptionsTo<T>(this TMP_Dropdown input, IReactiveCollection<T> options, Func<T, string> textLocator, Func<T, Sprite> spriteLocator = null)
        {
            var addSubscription = options.ObserveAdd().Subscribe(x =>
            {
        ...
        /// </summary>
        public static IDisposable BindOptionsTo<T>(this TMP_Dropdown input, ICollection<T> options, Func<T, string> textLocator, Func<T, Sprite> spriteLocator = null)
        {
